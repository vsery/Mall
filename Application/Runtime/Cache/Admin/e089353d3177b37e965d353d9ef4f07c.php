        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<p>
					...
					<span class="field"><input type="text" name="banks" id="banks" value="<?php echo ($_CFG["site"]["banks"]); ?>" class="smallinput" /></span>
				</p>
				<p>
					<label>关注编码前缀</label>
				...
				<p>
					<label>积分支付比例<small>多少积分相当于1RMB</small></label>
				...
				<p>
					<label>排行榜名称</label>
					<span class="field"><input type="text" name="rank_name" id="rank_name" value="<?php echo ($_CFG["site"]["rank_name"]); ?>" class="smallinput" /></span>
				</p>
				<p>
